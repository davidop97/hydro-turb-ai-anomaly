...
def open_gui():
    ...
    def update_threshold_fields(*args):
        ...
        Label(thresholds_frame, text="Ajustar Umbrales:", font=("Helvetica", 12, "bold"), bg="#F5F6FA", fg="#1E3A8A").grid(row=0, column=0, columnspan=4, sticky="w", padx=5, pady=5)
        colors_to_show = ["verde", "amarillo", "rojo"] if severity_value == 0 else [["verde", "amarillo", "rojo"][severity_value - 1]]
        for i, direction in enumerate(["GE-DE", "GE-NDE"]):
    ...
    threshold_entries = {"GE-DE": {}, "GE-NDE": {}}
